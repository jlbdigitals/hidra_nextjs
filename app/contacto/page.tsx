        ...
        <div className="max-w-[1140px] mx-auto px-4 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-xs font-bold uppercase tracking-wider mb-1" style={{ color: "#53B94A" }}>Teléfono</p>
              <p className="text-sm font-semibold" style={{ color: "#54595F" }}>+56 9 9710 7845</p>
            </a>
            ...
            >
              ...
              <p className="text-sm font-semibold" style={{ color: "#54595F" }}>Región de Valparaíso, Chile</p>
            </div>
            ...
            >
              ...
              <p className="text-xs" style={{ color: "#7A7A7A" }}>Sáb 9:00–13:00</p>
            </div>
